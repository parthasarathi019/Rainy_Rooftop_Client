           ...
           {image ?  <img className='w-[100%] h-[350px]' src={image} alt="" /> :  <img className='w-[100%] h-[350px]' src={Error_Item} alt="" />}
            ...
            <div className='py-8'>
                ...
                <div className='flex justify-center '>
                    <button onClick={()=>handle_AddToCart(pizza)} className='px-11 duration-300 py-2 rounded-md border-0 border-b-4 border-[#926703] hover:border-black bg-[#e8e8e8] hover:bg-black text-[#926703]'>add to cart</button>
                </div>
            </div>
        </section>
    );
