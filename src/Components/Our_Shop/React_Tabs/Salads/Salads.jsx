           ...
           <p className='text-white bg-black py-1 px-2 rounded-md text-[1.1em] font-bold absolute top-4 right-4'>﹩{price}</p>
            ...
            <div className='py-8'>
                ...
                <div className='flex justify-center '>
                    <button onClick={()=>handle_AddToCart(salad)} className='px-11 duration-300 py-2 rounded-md border-0 border-b-4 border-[#926703] hover:border-black bg-[#e8e8e8] hover:bg-black text-[#926703]'>add to cart</button>
                </div>
            </div>
        </section>
    );
