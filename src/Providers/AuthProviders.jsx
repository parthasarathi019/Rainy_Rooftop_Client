...
if (current_user) {
    axios.post('http://localhost:11000/jwt' , {email: current_user.email})
    .then(data => {
        console.log(data.data.token)
        localStorage.setItem('rainy-rooftop-access-token' , data.data.token)
        setloading(false)
    })
}else{
    localStorage.removeItem('rainy-rooftop-access-token')
}
setloading(false)
//𝓙𝓦𝓣💚𝓐𝓧𝓘𝓞𝓢||𝓙𝓦𝓣💚𝓐𝓧𝓘𝓞𝓢||𝓙𝓦𝓣💚𝓐𝓧𝓘𝓞𝓢||𝓙𝓦𝓣💚𝓐𝓧𝓘𝓞𝓢||𝓙𝓦𝓣💚𝓐𝓧𝓘𝓞𝓢||𝓙𝓦𝓣💚𝓐𝓧𝓘𝓞𝓢||𝓙𝓦𝓣💚𝓐𝓧𝓘𝓞𝓢||𝓙𝓦𝓣💚𝓐𝓧𝓘𝓞𝓢||𝓙𝓦𝓣💚𝓐𝓧𝓘𝓞𝓢||𝓙𝓦𝓣💚𝓐𝓧𝓘𝓞𝓢
